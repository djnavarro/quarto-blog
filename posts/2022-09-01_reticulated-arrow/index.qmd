...
> [Cass Wilkinson Saldaña](https://twitter.com/mxcatnap/status/1559991199494279169): If you were working on a bilingual (Python + R) Quarto project, and you'd want to hand off your (brilliantly cleaned, happy, thriving) tibble to a modeling stack in Python, how would you conduct the handoff?
>
...
```{r list-conda-env, filename="[R code]"}
conda_list()
```

I can do this with `use_miniconda()`, explicitly specifying the `condaenv` to be used:
