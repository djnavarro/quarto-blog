...
In the [last post on this blog](/posts/2022-09-09_reticulated-arrow/) I showed how Apache Arrow makes it possible to hand over data sets from R to Python (and vice versa) without making wasteful copies of the data. 
