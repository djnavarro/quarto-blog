...
They even have pretty pictures on the website. 
...
#| echo: false
#| column: margin
#| fig-cap: This was the first iteration of the whale system
whale(1)
```
...
#| eval: false
#| filename: "ghcr.io/djnavarro/arch-r:base Dockerfile"
...
```{bash locale-gen}
#| eval: false
#| filename: "ghcr.io/djnavarro/arch-r:base locale.gen"
C.UTF8 UTF-8
en_US.UTF-8 UTF-8
```
...
```{bash locale-conf}
#| eval: false
#| filename: "ghcr.io/djnavarro/arch-r:base locale.conf"
LANG=en_US.UTF-8
LC_ALL=en_US.UTF-8
```
...
#| eval: false
#| filename: "publish-docker-image.yaml"
