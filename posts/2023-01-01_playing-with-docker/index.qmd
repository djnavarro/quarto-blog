...
Let's see what happens when I try to build. The `arch-r-test` image is considerably larger than `arch-r-base`. This one isn't a frugal image! It takes a while, so I'm going to go have a smoke while I wait^[I am, after all, "on smoko" (which in my case means I am unemployed and bored out of my mind) but incidentally if you want to see the most fabulous cover ever (Wet Leg covering The Chats), [here it is](https://www.youtube.com/watch?v=P_dza9y6cg0).] but the nice thing is that if you've done it once you don't have to do it again. Anyway...
...
Step 2/7 : COPY clone-and-check.R /home/clone-and-check.R
 ---> f83258dcdeee
Step 3/7 : ARG user
 ---> Running in 200bae8e0a85
Removing intermediate container 200bae8e0a85
 ---> 82f0cbb2d2ad
Step 4/7 : ARG repo
 ---> Running in 85f22b6c7bdc
Removing intermediate container 85f22b6c7bdc
 ---> b1806a37d636
Step 5/7 : ENV user=$user
 ---> Running in f9368d0cd58f
Removing intermediate container f9368d0cd58f
 ---> 25fda6b7645e
Step 6/7 : ENV repo=$repo
 ---> Running in 7045b37b7432
Removing intermediate container 7045b37b7432
 ---> c0288e2c8dac
Step 7/7 : CMD Rscript /home/clone-and-check.R
 ---> Running in 68e730f44158
Removing intermediate container 68e730f44158
 ---> 081c995adc3c
Successfully built 081c995adc3c
...
```
REPOSITORY                      TAG       IMAGE ID       CREATED             SIZE
test-queue                      latest    081c995adc3c   9 minutes ago       4.99GB
my-system-check                 latest    489003ffb5d0   About an hour ago   955MB
ghcr.io/djnavarro/arch-r-test   release   4f873f316861   14 hours ago        4.99GB
ghcr.io/djnavarro/arch-r-base   release   0a9929e54a6b   14 hours ago        955MB
hello-world                     latest    feb5d9fea6a5   15 months ago       13.3kB
```
...
Step 4/7 : ARG repo
 ...
 ---> b1806a37d636
Step 5/7 : ENV user=$user
 ---> Running in f9036800f937
Removing intermediate container f9036800f937
 ---> acb5c19bbb93
Step 6/7 : ENV repo=$repo
 ---> Running in 9c3ca78bf379
Removing intermediate container 9c3ca78bf379
 ---> 6c1cf19da9be
Step 7/7 : CMD Rscript /home/clone-and-check.R
 ---> Running in f1746911174f
Removing intermediate container f1746911174f
 ---> cc634cbf837e
Successfully built cc634cbf837e
Successfully tagged test-praise:latest
```

It's verbose, but fast, and it hasn't wasted anything by creating unnecessary copies. 
...
```
REPOSITORY                      TAG       IMAGE ID       CREATED             SIZE
test-praise                     latest    cc634cbf837e   50 seconds ago      4.99GB
test-queue                      latest    081c995adc3c   13 minutes ago      4.99GB
my-system-check                 latest    489003ffb5d0   About an hour ago   955MB
ghcr.io/djnavarro/arch-r-test   release   4f873f316861   14 hours ago        4.99GB
ghcr.io/djnavarro/arch-r-base   release   0a9929e54a6b   14 hours ago        955MB
hello-world                     latest    feb5d9fea6a5   15 months ago       13.3kB
