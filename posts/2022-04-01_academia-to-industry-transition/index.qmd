...
```{r}
#| echo = FALSE,
#| fig.cap = "Image by Siora Photography. Available by CC0 licence on [unsplash](https://unsplash.com/photos/hgFY1mZY-Y0)."
knitr::include_graphics("img/siora-photography-hgFY1mZY-Y0-unsplash.jpg")
```
...
```{r}
#| echo = FALSE,
#| fig.cap = "Image by Sigmund. Available by CC0 licence on [unsplash](https://unsplash.com/photos/Y41w7pyxE18)."
knitr::include_graphics("img/sigmund-Y41w7pyxE18-unsplash.jpg")
```
...
```{r}
#| echo = FALSE,
#| fig.cap = "Image by Cristian Escobar. Available by CC0 licence on [unsplash](https://unsplash.com/photos/abkEAOjnY0s)."
knitr::include_graphics("img/cristian-escobar-abkEAOjnY0s-unsplash.jpg")
```
...
```{r}
#| echo = FALSE,
#| fig.cap = "Image by Lynn Vdbr. Available by CC0 licence on [unsplash](https://unsplash.com/photos/xeWTU66tJIo)."
knitr::include_graphics("img/lynn-vdbr-xeWTU66tJIo-unsplash.jpg")
```
...
```{r}
#| echo = FALSE,
#| fig.cap = "Image by Bryam Blanco. Available by CC0 licence on [unsplash](https://unsplash.com/photos/nXKWLn8y9qE)."
knitr::include_graphics("img/bryam-blanco-nXKWLn8y9qE-unsplash.jpg")
```
