...
> Slots are generally thought of as implementation detail that should not be directly accessed by the end-user ... [but] users know about @ and use it to access object internals even though they're not supposed to. S7 avoids these problems by accepting the fact that R is a data language, and that there’s no way to stop users from pulling the data they need out of an object. <br>
