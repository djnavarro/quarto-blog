...
date: "2023-05-16"
categories: [Statistics, Pharmacokinetics, Stan]
image: stan_logo.png
---
...
I'll also introduce the notation $d_t$ to refer to the (instantaneous) dose given at time $t$. In a moment, we'll be able to rewrite this a little. 
...
$$
\begin{array}{rcl}
\frac{da_g}{dt} &=& -k_a \ a_{gt}+ d_t \\
\frac{da_c}{dt} &=& k_a \ a_{gt} + \frac{q_i}{v_p} \ a_{pt} - \frac{q_i}{v_c} \ a_{ct} - \frac{q_e}{a_c} \ a_{ct}  \\
\frac{da_p}{dt} &=& - \frac{q_i}{v_p} \ a_{pt} + \frac{q_i}{v_c} \ a_{ct}
\end{array}
$$
...
Thrilling, I know! Let's see if this works when we run it, shall we?

## Fitting the model

Step one, sample from the model...
