...
- The "CW" button: This is used to attach content warnings to your post. **USE THIS BUTTON**. I cannot stress this enough: the button is right there, and it is considered extremely poor form in the fediverse to force your followers to look at content they might not want to see. There is a whole section on this later, but remember that mastodon is not twitter -- people will mute you or choose not to share your post if you don't use content warnings appropriately.
