...
**Edited to add:** Okay yes the demo app in this post isn't working right now, but that's not because the code doesn't work, it's because I haven't set up payments on google cloud account yet so the cluster isn't live! (March 15, 2023)
