...
Here's how you build the system. First, the plot is going to need a colour scheme, so we'll define a function that samples a palette randomly with the assistance of the ggthemes package:
