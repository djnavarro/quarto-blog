...
image-alt: "Abstract generative art in black and white"
categories: [Art]
format:
  html:
    css: "strapless.css"
...
When I started setting up on, I wandered around the Tezos cryptoart landscape in confusion, wandering aimlessly over the terrain. It was all *deeply* unsettling. Eventually I pieced together some overall view of things, but I wouldn't recommend doing things the same way I did. I think the best thing to do first is to "zoom out" and look at the landscape as a whole. The best site I've found for doing that is [tezos.art](https://tezos.art/). If you click on the link it will take you to a page with the following three sections: 
...
knitr::include_graphics("img/hen_menu_annotated.png")
```
...
- **search** takes you to the [HEN search page](https://www.hicetnunc.xyz/search)
...
- Second, you can give yourself a username. The advice I read on the relevant [HEN wiki page](https://github.com/hicetnunc2000/hicetnunc/wiki/Edit-your-profile) suggested that you should avoid spaces and special characters, and should stick to lower case letters because usernames are case sensitive. 
...
There's more stuff you can do to get your account set up, but you might want to take a little breather and look for some art. Maybe you want to search for someone you know in the R community who might be on HEN, and you'd like to find them. As I mentioned earlier, the HEN site does have a [search page](https://www.hicetnunc.xyz/search), but there are some limitations. It's okay if you want to search by keywords to *find* art or artists, but what it won't let you do is *follow* them. Personally, I quite like being able to follow artists whose work I love, and it would be pretty cool to have a feed where I can see what they've posted, arranged in chronological order. That's where the the "HEN explorer" website is handy:
...
```{r, echo=FALSE, fig.align='center'}
knitr::include_graphics("img/henext_connect.png")
```
...
Surprisingly, the process of releasing your art on HEN is quite easy, at least when compared to how complicated everything else is. If you open the menu and click on the "OBJKT (mint)" option, it will take you to the [minting page](https://www.hicetnunc.xyz/mint), which looks like this:

```{r, echo=FALSE, fig.align='center'}
knitr::include_graphics("img/hen_mint.png")
```
...
```{r, echo=FALSE, fig.align='center'}
knitr::include_graphics("img/hen_mint_step1.png")
```
...
```{r, echo=FALSE, fig.align='center'}
knitr::include_graphics("img/hen_mint_step2_annotated.png")
```
...
```{r, echo=FALSE, fig.align='center'}
knitr::include_graphics("img/hen_mint_step3.png")
```
...
The mechanism I've shown above is the simplest way to put art on sale: you list a price and wait for someone to purchase it. However, if you want to try more exotic options like auctions, you can check out [objkt.com](https://objkt.com).
...
df <- data.frame(
  image = c(
    "img/native-flora_110.png", 
    "img/native-flora_184.png", 
    "img/native-flora_196.png", 
    "img/native-flora_199.png"
  ),
  link = c(
    "https://www.hicetnunc.xyz/objkt/359814",
    "https://www.hicetnunc.xyz/objkt/359795",
    "https://www.hicetnunc.xyz/objkt/359761",
    "https://www.hicetnunc.xyz/objkt/359745"
  ), 
  objkt = paste("OBJKT", c(359814, 359795, 359761, 359745))
)
bs4cards::cards(df, title = objkt, image = image, link = link, width = 2)
```
...
<blockquote class="twitter-tweet" data-partner="tweetdeck"><p lang="en" dir="ltr">Mondrianomie 28<br>Basic cellular multiorganism grown according to neoplasticism assumptions (2033 x 2400 PNG)<br><br>3 ed - 28 tez at <a href="https://twitter.com/hicetnunc2000?ref_src=twsrc%5Etfw">@hicetnunc2000</a><a href="https://t.co/TyNvt1zMBu">https://t.co/TyNvt1zMBu</a><a href="https://twitter.com/hashtag/HEN?src=hash&amp;ref_src=twsrc%5Etfw">#HEN</a> <a href="https://twitter.com/hashtag/hicetnunc?src=hash&amp;ref_src=twsrc%5Etfw">#hicetnunc</a> <a href="https://twitter.com/hashtag/hicetnunc2000?src=hash&amp;ref_src=twsrc%5Etfw">#hicetnunc2000</a> <a href="https://twitter.com/hashtag/nft?src=hash&amp;ref_src=twsrc%5Etfw">#nft</a> <a href="https://twitter.com/hashtag/NFTs?src=hash&amp;ref_src=twsrc%5Etfw">#NFTs</a> <a href="https://twitter.com/hashtag/nftcommunity?src=hash&amp;ref_src=twsrc%5Etfw">#nftcommunity</a> <a href="https://twitter.com/hashtag/nftcollectors?src=hash&amp;ref_src=twsrc%5Etfw">#nftcollectors</a> <a href="https://twitter.com/hashtag/cleannft?src=hash&amp;ref_src=twsrc%5Etfw">#cleannft</a> <a href="https://twitter.com/hashtag/nftart?src=hash&amp;ref_src=twsrc%5Etfw">#nftart</a> <a href="https://twitter.com/hashtag/tezos?src=hash&amp;ref_src=twsrc%5Etfw">#tezos</a> <a href="https://twitter.com/hashtag/tezosart?src=hash&amp;ref_src=twsrc%5Etfw">#tezosart</a></p>&mdash; Antonio Sánchez Chinchón (@aschinchon) <a href="https://twitter.com/aschinchon/status/1441675525651640320?ref_src=twsrc%5Etfw">September 25, 2021</a></blockquote>
<script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>


## 7: Manage your identity 

There are at least three additional tools that may be useful to you in managing your identity in the peculiar world of cryptoart on the Tezos blockchain: (1) you can set up a [Tezos Profile](https://tzprofiles.com/), (2) you can establish an alias on the [Tezos Blockchain Explorer](https://tzkt.io/), and/or (3) you can purchase a [Tezos Domain](https://tezos.domains/). None of these are strictly necessary, but all of them offer some value to you as an artist on HEN so I'll discuss each one.  
...
```{r, echo=FALSE, fig.align='center'}
knitr::include_graphics("img/hen_profile_annotated.png")
```
...
<blockquote class="twitter-tweet"><p lang="et" dir="ltr">I am attesting that this twitter handle <a href="https://twitter.com/djnavarro?ref_src=twsrc%5Etfw">@djnavarro</a> is linked to the Tezos account tz1hXKn2BcU64HxSrmojfuf7cDoweJ9xwxZ7 for <a href="https://twitter.com/tzProfiles?ref_src=twsrc%5Etfw">@tzprofiles</a><br><br>sig:edsigtaH3nvbQjpiAfMCnT4zcQESZefXoVLPf2NEYaZeUfhwHjzRYp4oeBiiyDFLdrUAUvjBhvepyDFoxuyE2ynVYxd7TvV9fj6</p>&mdash; Danielle Navarro (@djnavarro) <a href="https://twitter.com/djnavarro/status/1440133754333237248?ref_src=twsrc%5Etfw">September 21, 2021</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
...
What might be surprising, particularly if you've just gone to the effort of setting up a Tezos Profile, is that the account information doesn't show my avatar. It doesn't include my name, or a bio, and it doesn't include my social media links. Instead, all I have is a cartoon image of a very suspicious looking cartoon cat. Unlike HEN, the [tzkt.io](https://tzkt.io) site doesn't pull information from your Tezos Profile. 

The mystery deepens a little when you start noticing that the exact same cartoon cat appears on various other sites. For example, this was how my profile looked on [objkt.com](https://objkt.com/) at the time: 
...
As it turns out, the source for all these skeptical cats is the blockchain explorer site, [tzkt.io](https://tzkt.io), and you can submit an application to the people who run that site to create an alias for you. The process is described in [this post](https://baking-bad.org/blog/2021/09/19/tzkt-alias-verification-f-a-q/) on the "Baking Bad" blog (don't let the name and silly images fool you, the blog is associated with the people who run the site). The post will take you to a Google Form that you can fill out, in order to have your alias created. When you do this, it won't update immediately: there is a manual verification process that takes about three days, so you'll need to be patient. 

Once that happens you'll discover that your links have appeared on your tzkt.io page, and more importantly perhaps, you have an avatar and description on other sites that make use of this alias. This is what my [profile page](https://objkt.com/profile/tz1hXKn2BcU64HxSrmojfuf7cDoweJ9xwxZ7/creations) on objkt.com looks like now: 

```{r, echo=FALSE, fig.align='center'}
knitr::include_graphics("img/objkt_updated.png")
```

Mine is a deliberately vague because I'm a peculiar person, but you can see a slightly more informative version if you look at [Thomas Lin Pedersen's profile](https://objkt.com/profile/tz2Pkj2xWJovKKCsABjnr3NbyMVJTMBkpTvb/creations):
...
Where that runs into some difficulty, for me at least, is that a lot of my generative art is deeply entwined with my personal life, with my moods, and my experiences. When done well, [art is always intimate](https://essays.djnavarro.net/post/intimacy-and-art/), and the intimacy of creating and sharing the art often entails personal disclosures that might not be welcome on twitter. Consider these pieces, for example:

```{r echo=FALSE}
df <- data.frame(
  image = c(
    "img/thorns_05_1014.png", 
    "img/thorns_05_1047.png", 
    "img/thorns_05_1053.png", 
    "img/thorns_05_1079.png"
  ),
  link = c(
    "https://www.hicetnunc.xyz/objkt/341833",
    "https://www.hicetnunc.xyz/objkt/341852",
    "https://www.hicetnunc.xyz/objkt/341868",
    "https://www.hicetnunc.xyz/objkt/341880"
  ), 
  objkt = paste("OBJKT", c(341833, 341852, 341868, 341880))
)
bs4cards::cards(df, title = objkt, image = image, link = link, width = 2)
```
